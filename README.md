...
I'm a Computer Engineering student at the **University of Padua**, holding a Technical Diploma in Computer Science and Telecommunications from ITT G. Chilesotti (100/100). I'm passionate about full-stack development, IT infrastructure, and building systems that just work — from the code to the network they run on.
...
**Databases:** SQL, phpMyAdmin, basic Oracle<br>
**Systems:** Windows, macOS, Linux (basics)<br>
**Networking:** Data network configuration, installation, and management<br>
